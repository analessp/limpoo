    ...
    <section id="inicio">
        <div>
            ...
            <div className="limpeza-icon">
                <a>
                    <img src="/public/assets/limpeza-icon.png" alt="Ícone de Limpeza" />
                </a>
            ...
            <div className="saude-icon">
                <a>
                    <img src="/public/assets/saude-icon.png" alt="Ícone de Saúde" />
                </a>
            ...
            <div className="economia-icon">
                <a>
                    <img src="/public/assets/economia-icon.png" alt="Ícone de Economia" />
                </a>
                <h4>ECONOMIA</h4>
